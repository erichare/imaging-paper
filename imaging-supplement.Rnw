...
knowns <- knowns[grep(" ", knowns)]
knowns <- gsub(".x3p", "", knowns)

unknowndatadir <- "app/images/Hamby252_3DX3P2of2/"
unknowns <- dir(path=unknowndatadir)
unknowns <- unknowns[grep(" ", unknowns)]
...
mm$path <- "app/images/Hamby252_3DX3P1of2//"
mm$path[unkns] <- "app/images/Hamby252_3DX3P2of2//"
...
bstats <- read.csv("data-25-25/bullet-stats-old.csv", stringsAsFactors = FALSE)
