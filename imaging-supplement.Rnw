...
\newpage
\section{One-on-one comparison of Hamby study}\label{supp:extended}
\hh{
add: we could extend the results of the James Hamby study by trying to match every single land against all other lands. This  almost doubles the number of comparisons ($21,115 = (118+88)\cdot 205/2$).  
}
...
\newpage
\section{Results from Random Forest}\label{supp:randomforest}
