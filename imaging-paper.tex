...
\end{figure}
%
\hh{For this alignment we use the cross-correlation function to find a maximal amount of agreement between the signatures~\cite{bachrach:2002, thompson:2013}.}
