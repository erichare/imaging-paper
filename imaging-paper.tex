...
\caption{\label{fig:manualmatch-rgl}3D view of the manually adjusted side-by-side comparison of bullet~1-5 and bullet 2-1 after removing the curvature. \hh{Bullet 2-1 is shaded light grey in the background.}}
\end{figure}
...
\end{figure}
%
\hh{For this alignment we use the cross-correlation function to find a maximal amount of agreement between the signatures~\cite{bachrach:2002, vorburger:2011, thompson:2013}.}
...
\hh{XXX The dots mark the equal error rate, i.e. the location on the ROC curve, where false positive and false negative error rates are the same. The smaller the value, the better. We see that in this instance a low EER goes hand in hand with high predictive power as measured in AUC. XXX HH: do we need to say more about EERs?}
