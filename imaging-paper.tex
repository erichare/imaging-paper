...
The typical number and width of striation markings on bullet varies significantly depending on the gun barrel. For instance, a Smith and Wesson barrel with a land-width of 2.4 millimeters contained an average 60 striae, with an average width of about 0.08 millimeters~\citep{chu:2011}.
...
\item \hh{The value of the cross-correlation function (ccf) between the aligned signatures \cite{vorburger:2011}, }
...
\includegraphics[width=.6\textwidth]{figure/tree:forest-2} 
