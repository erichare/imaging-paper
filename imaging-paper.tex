...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in 1:info\$num.pts.line: argument of length 0}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in subset(lof, x \%in\% crosscuts[i:(i + 1)]): object 'lof' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in lapply(X = X, FUN = FUN, ...): object 'reslist' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in lapply(reslist, function(res) \{: object 'reslist' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in arrangeGrob(...): object 'lop' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in readChar(con, 5L, useBytes = TRUE): cannot open compressed file 'data/data-25-25/unkn9.RData', probable reason 'No such file or directory'}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in readChar(con, 5L, useBytes = TRUE): cannot open the connection}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in lapply(X = X, FUN = FUN, ...): object 'reslist' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'cmsdist' not found}}\end{kframe}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'reslist' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in strsplit(as.character(x), split = "{}/"{}): object 'res' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in fortify(data): object 'res' not found}}\end{kframe}
\end{knitrout}
\end{subfigure}
\begin{subfigure}[b]{.49\textwidth}\centering
