...
To analyze the striation pattern, we extract a \emph{bullet profile} \citep{ma:2004} by taking a cross section of the surface measurements at a fixed height $x$ along the bullet land, as illustrated in Figure \ref{fig:allx3p}.
...
Figure \ref{fig:fixedX} shows a plot of the side profile of a bullet land. It can be seen that the global structure of the land dominates the appearance of the plot. The shoulders can be clearly identified on the left and right side, and the curvature of the surface is the most visible feature in the middle.
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in unzip(path, exdir = mydir): error 1 in extracting from zip file}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: 'NA' does not exist in current working directory ('/Users/heike/papers/2015-imaging-paper').}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning in unzip(path, exdir = mydir): error 1 in extracting from zip file}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: 'NA' does not exist in current working directory ('/Users/heike/papers/2015-imaging-paper').}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in data.frame(subLOFx1): object 'subLOFx1' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'lofX' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'lofX' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in factor(lofX\$r05): object 'lofX' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in levels(lofX\$type) <- c("{}groove"{}, NA, "{}peak"{}): object 'lofX' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'subLOFx1' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'subLOFx2' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in ccf(subLOFx1\$resid, subLOFx2\$resid, lag.max = 100, plot = FALSE): object 'subLOFx1' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in ccf\$lag: object of type 'closure' is not subsettable}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'subLOFx1' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in data.frame(subLOFx1): object 'subLOFx1' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in matches\$allnas: object of type 'closure' is not subsettable}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in matches\$allnas: object of type 'closure' is not subsettable}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in UseMethod("{}group\_by\_"{}): no applicable method for 'group\_by\_' applied to an object of class "{}function"{}}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in subset.default(lines, lineid != 0): object 'lineid' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in strsplit(as.character(x), split = "{}/"{}): object 'lofX' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in ggplot(data, aesthetics, environment = env): object 'lofX' not found}}\end{kframe}
\end{knitrout}
    }
\end{subfigure}
\begin{subfigure}[t]{\textwidth}\centering
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in rbind(subLOFx1, subLOFx2): object 'subLOFx1' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'lof' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in unique(data\$bullet): object 'lof' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'bAlign' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in unique(lof\$bullet): object 'lof' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in subset(lofX, bullet == b12[1]): object 'lofX' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in subset(lofX, bullet == b12[2]): object 'lofX' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'b12' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'b12' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in rbind(peaks1\$lines, peaks2\$lines): object 'peaks1' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in strsplit(as.character(x), split = "{}/"{}): object 'peaks' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in strsplit(as.character(x), split = "{}/"{}): object 'lofX' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in fortify(data): object 'peaks' not found}}\end{kframe}
\end{knitrout}
}
\end{subfigure}    
\begin{subfigure}[t]{\textwidth}\centering
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in rbind(lines1, lines2): object 'peaks1' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in !match: invalid argument type}}\end{kframe}
\end{knitrout}
    }
\end{subfigure}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in strsplit(as.character(x), split = "{}/"{}): object 'lof' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in ggplot(data, aesthetics, environment = env): object 'lof' not found}}\end{kframe}
\end{knitrout}
    }
\end{subfigure}    
\begin{subfigure}[b]{.49\textwidth}\centering
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in strsplit(as.character(x), split = "{}/"{}): object 'lofY' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in ggplot(data, aesthetics, environment = env): object 'lofY' not found}}\end{kframe}
\end{knitrout}
    }
\end{subfigure}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in ccf\$lag: object of type 'closure' is not subsettable}}\end{kframe}
...
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
\includegraphics[width=.5\textwidth]{figure/smoothfac1-1} 
...
\begin{figure}[hbtp]
\begin{subfigure}[t]{\textwidth}\centering
\caption{Maximal number of CMS between unknown bullet land C-3 and all of the other 118 considered (known) lands. For two lands the number of maximum CMS is high. }
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
