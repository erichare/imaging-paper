...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in reslist[[which(cmsdist == 14)]]: attempt to select less than one element in get1index}}\end{kframe}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in reslist[[106]]: subscript out of bounds}}\end{kframe}
