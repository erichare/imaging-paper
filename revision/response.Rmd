...
***We have detailed a multi-stage analysis process that begins with a source image, processes the image, extracts features, and ultimately uses a random forest to compute predicted match probabilities. While the forest is a component of the process, we've taken care to emphasize that the preceeding steps outline a more general framework for analysis of striae in images that could theoretically apply to other forensic science questions as well. 

***EH: TODO: Add to paper***
...
***HH: Could you look at this response i wrote?***

***We were not intending to provide new insights on random forests. The insights were in the feature extraction and image processing leading up to the random forest fit. As the forest ultimately predicted every land-to-land comparison properly, we felt that a comparison to other learning methods wass outside the scope of this paper. Had a wider variety of data been available, there would likely be more variability in the predictions and a comparison to other learning methods would be prudent. For this particular paper, however, the groove detection, profile extraction, and feature definitions were the intended focus.***
