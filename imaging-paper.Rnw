...
@
\end{subfigure}
\caption{\label{fig:residual} Residual structure of  circular fits at two different cross-section. Both residual plots show systematic structures, indicating that the fit is not entirely appropriate. }
\end{figure}
