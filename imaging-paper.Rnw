...
\begin{figure}
\begin{subfigure}[t]{\linewidth}
\caption{\label{fig:loess_step1}Step 1 the Loess fit algorithm. For a fixed crosscut (x held constant at 243.75) height values for part 1 of bullet 1 are plotted across different values of y.}
...
@    
\caption{\label{fig:loessfits} Residuals of a loess fit to bullets 1 and 2 from barrel 1. Land 1 of bullet 1 is shown in black. }
\end{figure}
