...
In an approach to analyze the striation pattern we extract a \emph{bullet profile} \citep{ma:2004} by taking a cross section across the surface measurements at a fixed value of the bullet's height, denoted by $x$.
