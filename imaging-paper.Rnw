...
\caption{View from the side. \hh{XXX it's ambigious to talk about side and top. because it's not the side of the bullet(land), but the `side' of the data. I'm not sure, how to phrase it, though. How about: View of the data along the circumference of the bullet (circular segment of about 30 degrees). }\label{fig:sidex3p}}{%
      \includegraphics[width=\textwidth]{images/sidex3p.png}
    }
\end{subfigure}    
\begin{subfigure}[t]{.65\textwidth}\centering
    \caption{View from the top. \hh{XXX same problem as above. XXX How about: View of a bullet land (lower end of the view is the bottom of the bullet). }\label{fig:topx3p}}{%
