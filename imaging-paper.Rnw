...
br112_bullet <- get_bullet(paste(datadir,"Br1 Bullet 1-2.x3p", sep = "/"))
br113_bullet <- get_bullet(paste(datadir,"Br1 Bullet 1-3.x3p", sep = "/"))
br114_bullet <- get_bullet(paste(datadir,"Br1 Bullet 1-4.x3p", sep = "/"))
br115_bullet <- get_bullet(paste(datadir,"Br1 Bullet 1-5.x3p", sep = "/"))
br116_bullet <- get_bullet(paste(datadir,"Br1 Bullet 1-6.x3p", sep = "/"))
...
br111.groove <- get_grooves(br111_bullet)
br112.groove <- get_grooves(br112_bullet)
br113.groove <- get_grooves(br113_bullet)
br114.groove <- get_grooves(br114_bullet)
br115.groove <- get_grooves(br115_bullet)
br116.groove <- get_grooves(br116_bullet)

my.loess1 <- fit_loess(br111_bullet, br111.groove)
my.loess2 <- fit_loess(br112_bullet, br112.groove)
my.loess3 <- fit_loess(br113_bullet, br113.groove)
my.loess4 <- fit_loess(br114_bullet, br114.groove)
my.loess5 <- fit_loess(br115_bullet, br115.groove)
my.loess6 <- fit_loess(br116_bullet, br116.groove)
