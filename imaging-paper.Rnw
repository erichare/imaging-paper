...
\caption{\label{fig:manualmatch}\hh{Manually adjusted side-by-side comparison of two lands from different bullets.}}
\end{figure}

\begin{figure}
\includegraphics[width=\columnwidth]{images/matchup-rgl.png}
\caption{\label{fig:manualmatch}\hh{Different view of the manually adjusted side-by-side comparison of two lands from different bullets.}}
\end{figure}
