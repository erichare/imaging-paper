...
In this section, we are going to describe the algorithm for matching signatures first, and discuss the impact of parameter choices in the subsections thereafter.
