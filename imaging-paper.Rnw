...
imgdir <- "Figure/"
codedir <- "code"
datadir <- "/Users/heike/papers/dissertations/eric-dissertation/images/Hamby (2009) Barrel/bullets/"
...
qplot(data = dframe, x=lag, xend=lag, y = 0, yend= acf, geom="segment", colour = I("grey50")) + 
  ...
  scale_x_continuous(breaks = c(-100, -50, maxlag, 0, 50, 100),
