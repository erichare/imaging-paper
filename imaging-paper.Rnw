...
In addition to the features listed above, we also keep track of the value of the cross-correlation function found during the alignment, the lag at which signatures show the best alignment, and the cross section levels ($x_1$ and $x_2$).
