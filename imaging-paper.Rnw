...
\hh{We exclude these four lands from the further matching considerations and 
 run all unknown bullets against all known bullets for matches. 
The algorithm is using land-to-land matches, i.e. we are running $15 \times 6 -2 = 90 - 2 = 88$ lands from unkown bullets against $2 \times 10 \times 6 -2 = 120 - 2 = 118$ lands from known bullets, yielding a total of $10,384$ land-to-land comparisons. }
