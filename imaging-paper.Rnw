...
\caption{\label{fig:manualmatch}\hh{Different view of the manually adjusted side-by-side comparison of land five of bullet 1 and land 1 of bullet 2.}}
\end{figure}
...
qplot(y, resid, group=bullet, colour=bullet, data=lofX, geom="line") + 
  scale_colour_brewer(palette="Set1") + theme_bw() +
