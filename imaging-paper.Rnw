...
\begin{keyword}
\hh{XXX not the right keywords yet} 3d Topological Surface Measurement, Data visualization, Statistical graphics, Statistical computing.
\end{keyword}
...
%' @
\includegraphics[width=\linewidth]{images/br6-2-1.png}
\end{subfigure}
\begin{subfigure}[t]{.49\textwidth}
\caption{Br9 Bullet 2-4}
\includegraphics[width=\linewidth]{images/br9-2-4.png}
\end{subfigure}
\begin{subfigure}[t]{.49\textwidth}
\caption{Unkn Bullet B-2}
\includegraphics[width=\linewidth]{images/b-2.png}
\end{subfigure}
\begin{subfigure}[t]{.49\textwidth}
\caption{Unkn Bullet Q-4}
\includegraphics[width=\linewidth]{images/q-4.png}
\end{subfigure}
...
\begin{figure}[hbtp]
<<tree:forest, echo=FALSE, fig.width=6, fig.height=6.25, out.width='.7\\linewidth'>>=
...
\hh{XXX Needs still an answer: under what circumstances do we decide on match/no-match successfully?}
