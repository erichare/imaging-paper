...
\caption{Maximal number of CMS between Bullet land and all of the 120 other (known) lands. For two lands the number of maximum CMS is high. }
<<cms, echo=FALSE, fig.width=5, fig.height=3, out.width='\\textwidth'>>=
...
\end{subfigure}
\begin{subfigure}[t]{.49\textwidth}
\caption{Overlaid lines of the land of the unknown bullet and the land with the top matching CMS.}
<<top, echo=FALSE, fig.width=5, fig.height=3, out.width='\\textwidth'>>=
...
\caption{Overlaid lines of the land of the unknown bullet and the land with the second top matching CMS.}
<<top2, echo=FALSE, fig.width=5, fig.height=3, out.width='\\textwidth'>>=
#res <- reslist[[which.max(cmsdist)]]  
res <- reslist[[which.max(cmsdist[-which.max(cmsdist)])]]  # number 2
