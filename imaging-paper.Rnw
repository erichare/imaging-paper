...
<<residual2, dependson='fixedX', echo=FALSE, warning=FALSE, fig.height=3, out.width='.5\\linewidth'>>=
...
<<residual, dependson='fixedX', echo=FALSE, warning=FALSE, fig.height=3, out.width='.5\\linewidth'>>=
...
qplot(y, resid, data=subset(db2, x == 100), #colour=factor(x), 
  ...
  facet_wrap(~part, ncol=3) + scale_colour_brewer(palette="Paired") +
...
<<loess_fit, echo=FALSE, fig.width=10, fig.height=3.5, out.width='.5\\linewidth', warning=FALSE,  message=FALSE>>=
...
<<loess_resid, echo=FALSE, fig.width=10, fig.height=3.5, out.width='.5\\linewidth', warning=FALSE>>=
...
<<crosscuts, echo=FALSE, dependson='twolands100', fig.width=7, fig.height=3, out.width='.5\\textwidth'>>=
...
<<crosscutsX, echo=FALSE, dependson='twolands100', fig.width=7, fig.height=3, out.width='.5\\textwidth'>>=
...
\begin{figure}[hbtp]
  \centering
<<crosscuts-vary, echo=FALSE, fig.width = 7, fig.height = 12, out.width = '.5\\linewidth', cache=TRUE, warning = FALSE>>=
paths <- file.path(datadir, dir(datadir))
...
\begin{figure}[hbtp]
  \centering
<<crosscuts-vary-b31, echo=FALSE, fig.width = 7, fig.height = 10, out.width = '.5\\linewidth', cache=TRUE, warning = FALSE>>=
paths <- file.path(datadir, dir(datadir))
...
\begin{figure}[hbtp]
  \centering
<<barrel2, echo=FALSE, fig.width = 7, fig.height=12, out.width='.5\\linewidth', warning=FALSE>>=
...
<<top, echo=FALSE, fig.width=7, fig.height=3.25, out.width='.5\\textwidth', warning = FALSE>>=
...
<<top2, echo=FALSE, fig.width=7, fig.height=3.25, out.width='.5\\textwidth', warning = FALSE>>=
