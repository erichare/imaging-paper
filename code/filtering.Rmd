...
```{r}
my.loess$data$smoothed_first <- my.loess$data$resid - smth.gaussian(my.loess$data$resid, window = 16)
my.loess$data$smoothed <- my.loess$data$smoothed_first - smth.gaussian(my.loess$data$smoothed_first, window = 160)
